...
const questionsByCategory = {
  ...
  retos: [
    { text: "¿En que ano se firmo la declaracion universal de los derechos humanos?", correctAnswer: "1948", options: ["1945", "1948", "1950", "1952"] },
    { text: "¿Cual es el idioma mas hablado del mundo?", correctAnswer: "Chino mandarin", options: ["Ingles", "Espanol", "Chino mandarin", "Hindi"] },
    { text: "¿Quien pintó la Mona Lisa?", correctAnswer: "Leonardo da Vinci", options: ["Miguel Angel", "Leonardo da Vinci", "Rafael", "Donatello"] },
    { text: "¿Cual es el pais mas grande del mundo?", correctAnswer: "Rusia", options: ["Canada", "Rusia", "China", "Estados Unidos"] },
    { text: "¿En que continente se encuentra Egipto?", correctAnswer: "Africa", options: ["Asia", "Africa", "Europa", "America"] },
    { text: "¿Cual es el rio mas largo del mundo?", correctAnswer: "Rio Amazonas", options: ["Rio Nilo", "Rio Amazonas", "Rio Misisipi", "Rio Yangtze"] },
    { text: "¿Que invento es atribuido a Gutenberg?", correctAnswer: "La imprenta", options: ["La brujula", "La imprenta", "El telescopio", "La polvora"] },
    { text: "¿Cual es la moneda oficial de Japón?", correctAnswer: "Yen", options: ["Yuan", "Won", "Yen", "Rupia"] },
    { text: "¿En que ano llego el hombre a la luna?", correctAnswer: "1969", options: ["1965", "1969", "1972", "1975"] },
    { text: "¿Cual es el metal liquido a temperatura ambiente?", correctAnswer: "Mercurio", options: ["Plomo", "Mercurio", "Estaño", "Aluminio"] },
    { text: "¿Quien escribio 'Romeo y Julieta'?", correctAnswer: "William Shakespeare", options: ["Charles Dickens", "William Shakespeare", "Jane Austen", "Mark Twain"] },
    { text: "¿Cual es el hueso mas pequeno del cuerpo humano?", correctAnswer: "Estribo", options: ["Yunque", "Martillo", "Estribo", "Femur"] },
    { text: "¿En que pais se encuentra la Torre Eiffel?", correctAnswer: "Francia", options: ["Italia", "Francia", "Espana", "Alemania"] },
    { text: "¿Cual es el animal terrestre mas grande?", correctAnswer: "Elefante africano", options: ["Jirafa", "Elefante africano", "Rinoceronte", "Hipopotamo"] },
    { text: "¿Cuantos lados tiene un hexagono?", correctAnswer: "6", options: ["5", "6", "7", "8"] },
    { text: "¿Que gas de efecto invernadero es el mas abundante?", correctAnswer: "Vapor de agua", options: ["CO2", "Vapor de agua", "Metano", "Oxido nitroso"] },
    { text: "¿En que ano comenzo la Segunda Guerra Mundial?", correctAnswer: "1939", options: ["1935", "1939", "1941", "1945"] },
    { text: "¿Cual es la capital de Australia?", correctAnswer: "Canberra", options: ["Sydney", "Melbourne", "Canberra", "Brisbane"] },
    { text: "¿Que cientifico propuso la teoria de la relatividad?", correctAnswer: "Albert Einstein", options: ["Isaac Newton", "Albert Einstein", "Stephen Hawking", "Niels Bohr"] },
    { text: "¿Cual es el oceano mas profundo?", correctAnswer: "Oceano Pacifico", options: ["Oceano Atlantico", "Oceano Indico", "Oceano Pacifico", "Oceano Artico"] },
    { text: "¿Cuantos segundos tiene un dia?", correctAnswer: "86400", options: ["3600", "43200", "86400", "172800"] },
    { text: "¿Que pais tiene forma de bota?", correctAnswer: "Italia", options: ["Grecia", "Italia", "Espana", "Portugal"] },
    { text: "¿Cual es la montaña mas alta del mundo?", correctAnswer: "Everest", options: ["K2", "Kangchenjunga", "Everest", "Lhotse"] },
    { text: "¿Que organo produce la hormona del crecimiento?", correctAnswer: "Hipofisis", options: ["Tiroides", "Hipofisis", "Suprarrenal", "Pancreas"] },
    { text: "¿En que ano cayo el Muro de Berlin?", correctAnswer: "1989", options: ["1987", "1989", "1991", "1993"] },
    { text: "¿Cual es el elemento quimico con simbolo K?", correctAnswer: "Potasio", options: ["Kriptón", "Potasio", "Calcio", "Sodio"] },
    { text: "¿Cuantas cuerdas tiene una guitarra estandar?", correctAnswer: "6", options: ["4", "5", "6", "8"] },
    { text: "¿Que civilizacion construyo Machu Picchu?", correctAnswer: "Inca", options: ["Maya", "Azteca", "Inca", "Olmeca"] },
    { text: "¿Cual es la temperatura minima teorica (cero absoluto) en Celsius?", correctAnswer: "-273.15°C", options: ["-100°C", "-273.15°C", "-459.67°C", "0°C"] },
    { text: "¿En que continente se origino el ser humano?", correctAnswer: "Africa", options: ["Asia", "Africa", "Europa", "America"] },
    { text: "¿Cual es el simbolo quimico del calcio?", correctAnswer: "Ca", options: ["Cl", "Ca", "Co", "C"] },
    { text: "¿Que instrumento mide la presion atmosferica?", correctAnswer: "Barometro", options: ["Termometro", "Barometro", "Anemometro", "Higrometro"] },
    { text: "¿Cual es la galaxia mas cercana a la Via Lactea?", correctAnswer: "Andromeda", options: ["Triangulum", "Andromeda", "Centaurus A", "Sombrero"] },
    { text: "¿En que ano se descubrio America?", correctAnswer: "1492", options: ["1482", "1492", "1500", "1510"] },
    { text: "¿Cual es el numero atomico del carbono?", correctAnswer: "6", options: ["4", "6", "8", "12"] },
    { text: "¿Que pais invento la pizza?", correctAnswer: "Italia", options: ["Francia", "Italia", "Grecia", "Espana"] },
    { text: "¿Cual es la capa mas externa de la Tierra?", correctAnswer: "Corteza", options: ["Manto", "Corteza", "Nucleo", "Astenosfera"] },
    { text: "¿Cuantos planetas tiene el sistema solar?", correctAnswer: "8", options: ["7", "8", "9", "10"] },
    { text: "¿Que vitamina previene el escorbuto?", correctAnswer: "Vitamina C", options: ["Vitamina A", "Vitamina B", "Vitamina C", "Vitamina D"] },
    { text: "¿Cual es la capital de Canada?", correctAnswer: "Ottawa", options: ["Toronto", "Vancouver", "Ottawa", "Montreal"] },
    { text: "¿Que tipo de energia tiene un objeto en movimiento?", correctAnswer: "Energia cinetica", options: ["Energia potencial", "Energia cinetica", "Energia termica", "Energia elastica"] },
    { text: "¿En que pais se encuentra el desierto del Sahara principalmente?", correctAnswer: "Argelia", options: ["Egipto", "Libia", "Argelia", "Marruecos"] },
    { text: "¿Cual es el animal mas inteligente despues del humano?", correctAnswer: "Chimpancé", options: ["Delfin", "Chimpancé", "Elefante", "Cuervo"] },
    { text: "¿Que gas compone la mayor parte de la atmosfera terrestre?", correctAnswer: "Nitrogeno", options: ["Oxigeno", "Nitrogeno", "Dioxido de carbono", "Argon"] },
    { text: "¿Cual es la formula de la glucosa?", correctAnswer: "C6H12O6", options: ["C6H12O6", "CO2", "H2O", "NaCl"] },
    { text: "¿En que ano se fundo la ONU?", correctAnswer: "1945", options: ["1940", "1945", "1950", "1955"] },
    { text: "¿Cual es la unidad de medida de la corriente electrica?", correctAnswer: "Amperio", options: ["Voltio", "Amperio", "Ohmio", "Vatio"] },
    { text: "¿Que estructura celular contiene el ADN?", correctAnswer: "Nucleo", options: ["Mitocondria", "Ribosoma", "Nucleo", "Citoplasma"] },
    { text: "¿Cual es el libro mas vendido de la historia?", correctAnswer: "La Biblia", options: ["Don Quijote", "La Biblia", "El Coran", "Harry Potter"] },
    { text: "¿Cual es el planeta enano que fue considerado planeta?", correctAnswer: "Pluton", options: ["Ceres", "Pluton", "Eris", "Makemake"] }
  ]
};
